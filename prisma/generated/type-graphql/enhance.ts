...
const crudResolversMap = {
  Area: crudResolvers.AreaCrudResolver
};
const actionResolversMap = {
  Area: {
    area: actionResolvers.FindUniqueAreaResolver,
    findFirstArea: actionResolvers.FindFirstAreaResolver,
    areas: actionResolvers.FindManyAreaResolver,
    createArea: actionResolvers.CreateAreaResolver,
    deleteArea: actionResolvers.DeleteAreaResolver,
    updateArea: actionResolvers.UpdateAreaResolver,
    deleteManyArea: actionResolvers.DeleteManyAreaResolver,
    updateManyArea: actionResolvers.UpdateManyAreaResolver,
    upsertArea: actionResolvers.UpsertAreaResolver,
    aggregateArea: actionResolvers.AggregateAreaResolver,
    groupByArea: actionResolvers.GroupByAreaResolver
  }
};
